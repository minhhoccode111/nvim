...
return {
  ...
  config = function()
    ...
    ----------------------------------------
    -- mini.comment — Toggle comments (replaces Comment.nvim)
    --
    -- - gc  - comment operator (gc motion, gcc line)
    -- - gb  - block comment operator
    require('mini.comment').setup()

    -- Custom <C-/> mappings (terminal sends <C-_> for <C-/>)
    map('n', '<C-/>', function()
    ...
    map('i', '<C-/>', function()
      ...
      require('mini.comment').toggle_lines(lnum, lnum)
    ...
    ----------------------------------------
    -- mini.pairs — Auto-close brackets/quotes (replaces nvim-autopairs)
    ...
    ----------------------------------------
    -- mini.indentscope — Indent guides + scope textobjects (replaces indent-blankline)
    --
    -- - []  - jump to previous indentation edge
    -- - ][  - jump to next indentation edge
    -- - ai  - around indent textobject (select scope body + border)
    -- - ii  - inside indent textobject (select scope body)
    ...
    ----------------------------------------
    -- mini.tabline — Buffer tabs at top (replaces bufferline.nvim)
