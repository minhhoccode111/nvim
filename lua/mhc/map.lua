...
end, { desc = '[D]iagnostic: [k]Previous message' })
map('n', '<leader>j', function()
  vim.diagnostic.jump { count = 1 }
end, { desc = '[D]iagnostic: [j]Next message' })
map('n', '<leader>e', vim.diagnostic.open_float, { desc = '[D]iagnostic: [E]rror messages show' })
map('n', '<leader>q', vim.diagnostic.setloclist, { desc = '[D]iagnostic: [Q]uickfix list open' })
